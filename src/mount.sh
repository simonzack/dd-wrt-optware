...
#'---' is the argument to -t, i.e. the descriptor field in the logs
...
#it takes time to mount, wait until actually mounted before running startup scripts
...
#run startup script (mounts swap there to save nvram)
